...
export default function Banner() {
  return (
    <div className="relative overflow-hidden bg-white font-sans h-72 mx-auto max-w-screen-xl sm:py-4 md:px-6 ">
      {/* Banner Image */}
      <img
        ...
        alt="banerimg"
        className=" opacity-80 absolute inset-0 w-full h-full object-cover mx-auto "
      />
